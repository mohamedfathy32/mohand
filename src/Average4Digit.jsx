...
export default function Average4Digit() {
    ...
    const calculateAverage = () => {
        ...
        if (validNumbers.length !== 4) {
            setError("انا اسف يحبيب اخوك بس لازم تدخل الاربع ارقام");
            setAverage(null);
            return;
        }
    ...
    return (
        ...
        >
            ...
            <p style={{ fontSize: "25px", marginBottom: "30px", marginTop: "0px", paddingTop: "20px" }}>ده متوسط 4 أرقام يا هانو</p>
